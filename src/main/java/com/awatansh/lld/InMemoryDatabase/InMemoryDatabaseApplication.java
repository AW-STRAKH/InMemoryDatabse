package com.awatansh.lld.InMemoryDatabase;

import com.awatansh.lld.InMemoryDatabase.Datastore.TableHeader;
import com.awatansh.lld.InMemoryDatabase.Services.DatabaseManagerService;
...
public class InMemoryDatabaseApplication {
	...
	public static void main(String[] args) {
		...
		try{
			...
			dbService.insertEntryinTable("Employee", Arrays.asList("awatansh", 24));
